...
interface ApiService {
        @POST("v3/5c74ec0e-5cc1-445e-b64b-b76b286b215f")
        suspend fun getAccounts(): Response<Flow<List<AccountDto>>>

        @GET("v3/4253786f-3500-4148-9ebc-1fe7fb9dc8d5")
        suspend fun verifyAccount(@Query("account_number") accountNumber: String): Response<Flow<AccountDto>>

        @GET("v3/d9eab148-a083-4625-9f9a-9ada0d409ba3")
        suspend fun getConversionRate(@Query("from_account") fromAccount: String, @Query("to_account") toAccount: String): Response<Flow<ConversionRateDto>>
}